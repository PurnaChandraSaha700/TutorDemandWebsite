...
$studentEmailReceivedfromStudentHomePage = $_SESSION['studentEmailfromStudentHomepage'];

//$_SESSION['studentEmailfromStudentHomepage'] = $studentEmailReceivedfromStudentHomePage;
?>
...
<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insertQuery = "UPDATE studenttable set studentProfilePicture=? WHERE studentEmail = ?";
        $stmt = $conn->prepare($insertQuery);
        $stmt->bind_param("ss",$imageData, $studentEmailReceivedfromStudentHomePage);
        if ($stmt->execute()) {
